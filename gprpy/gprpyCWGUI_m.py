...
class GPRPyCWApp:
    ...
    def __init__(self,master):
        ...
        ToolTip(LoadButton,"Load .gpr, .DT1, .DZT, or BSQ data.")
        ...
        ToolTip(satlabel,"Stacked amplitude color saturation")
        ...
        #                                "analysis.")
        ToolTip(VelrngButton,"Set the velocity range\n"
                                       "used in the stacked amplitude\n"
                                       "analysis.")    
        # X range
        ...
        ToolTip(contrlabel,"Data color saturation")
