...
class GPRPyApp:
    ...
    def __init__(self,master):
        ...
        ToolTip(FullButton,"Resets x- and y-axis limits to full data.")
        ...
        ToolTip(GridButton,"Toggles grid on/off.")
        ...
        ToolTip(XrngButton,"Set the x-axis display limits.")
        ...
        ToolTip(YrngButton,"Set the y-axis display limits.")
        ...
        ToolTip(AspButton, "Set the aspect ratio between x- and y-axis.")
        ...
        ToolTip(contrlabel,"Set color saturation")
        ...
        ToolTip(LoadButton,"Load .gpr, .DT1, or .DZT data.")
